...
class ColorDetectionServer(Node):
    def __init__(self, name):
        ...
        self.declare_parameters(
            ...
            parameters=[
                ...
                # td xuyaoshanchu
                ('aim_color', 2, ParameterDescriptor(description='Target color to check (1=orange, 2=green, 3=blue)', type=ParameterType.PARAMETER_INTEGER,integer_range=[IntegerRange(from_value=1, to_value=3, step=1)])),
    ...
    def get_distance_error_callback(self, request, response):
        ...
        if request.data:  # 如果请求为 true
            if hasattr(self, 'dx_mm') and hasattr(self, 'dy_mm') and self.dx_mm is not None and self.dy_mm is not None:
                ...
                response.message = f"x: {-(self.dy_mm+60)/1000:.2f}, y: {-self.dx_mm/1000:.2f}"
            else:
    ...
    def declare_color_parameters(self):
        ...
        color_params = [
            ...
            ('red_h_high', 0, ParameterDescriptor(description='Red H high', type=ParameterType.PARAMETER_INTEGER,integer_range=int_range_0_180)),
            ...
            ('orange_s_low', 10, ParameterDescriptor(description='Orange S low', type=ParameterType.PARAMETER_INTEGER, integer_range=int_range_0_255)),
