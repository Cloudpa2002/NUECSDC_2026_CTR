...
def generate_launch_description():
    ...
    planning_horizon = LaunchConfiguration('planning_horizon', default=8.5)
    ...
    ego_planner_node = Node(
        ...
        parameters=[
            ...
            {'grid_map/obstacles_inflation': 0.4},    #####    Air_detect 0.3  large model 0.4
            ...
            {'grid_map/virtual_ceil_height': 1.0},      #large model 1.0  air_dedtect 1.2
