...
def generate_launch_description():
    ...
    map_size_x = LaunchConfiguration('map_size_x', default='15.0')
    ...
    advanced_param_include = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(
            get_package_share_directory('ego_planner'), 'launch', 'largemodel_advanced_param.launch.py')),
        launch_arguments={
            'drone_id': drone_id,
    ...
    cxr_egoctrl_v1_node = Node(
        package='ego_planner',
        executable='largemodel_egoctrl_v1', 
        name='largemodel_egoctrl_v1_node',
        output='screen'
    )
