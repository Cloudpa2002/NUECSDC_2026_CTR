...
class Mask:
    ...
    def mask2(self):
        ...
        if not self.pos_control.publish_goal([2.75, 1.98, 1.45], position_th=0.2):
            return False
        ...
        if not self.pos_control.publish_goal([1.09, 2.56, 1.53], position_th=0.2, velocity_th=5.0):
            return False
